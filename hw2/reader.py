...
parser = OptionParser()
parser.add_option("-i", "--input", help="The input file containing tuples.", default="/home/jon/School/MachineTranslation/sp2013.11-731/hw2/data/tok/test.hyp1-hyp2-ref")
parser.add_option("-d", "--dev", help="The input file containing dev tuples.", default="/home/jon/School/MachineTranslation/sp2013.11-731/hw2/data/tok/train.hyp1-hyp2-ref")
